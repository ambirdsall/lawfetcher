...
var EXPIRATION_INTERVAL_MILLISECONDS = 7 * ONE_DAY;
...
function setPreference($button) {
  ...
  localforage.setItem("autoforward", preferenceSetting, function (err, preference) {
    if (err) {
      ...
      $button.html(buttonText.isSet).addClass("btn-warning  js-isPreference").removeClass("btn-default");
    }
  });
}
function unsetPreference($button) {
  localforage.removeItem("autoforward", function (err) {
    if (err) {
      ...
      $button.html(buttonText.notSet).removeClass("js-isPreference  btn-warning").addClass("btn-default");
    }
  });
}
...
},{"localforage":26}],2:[function(require,module,exports){
"use strict";

var each = require("lodash/each");
var urlDecode = require("../functions/urlHelpers").urlDecode;
var Clipboard = require("clipboard");
var clipboard = new Clipboard(".js-clipboard");
var Source = require("../types/source");
var Citation = require("../types/citation");
var sourceList = require("../data/source_list");

var encodedQuery = window.location.search.slice(1);
...
// copy button.
$permalink.mouseup(function () {
  return $(undefined).select();
});
...
if (document.queryCommandSupported("copy")) {
  ...
  clipboard.on("success", function (e) {
    ...
    $this.attr("data-original-title", "Copied!").tooltip("show").one("mouseleave", fixTooltipTitle);
...
function insertUrl(source, parsedCitation) {
  ...
  var citationText = source.canDeepLink(parsedCitation.type) ? parsedCitation.fullCite : parsedCitation.mainCite;

  source.$anchor.attr({
    href: url,
    target: "_blank"
  }).append($linkCitation.html(citationText)).append($linkUrl.html(url));
}

},{"../data/source_list":4,"../functions/urlHelpers":9,"../types/citation":10,"../types/source":11,"clipboard":21,"lodash/each":146}],3:[function(require,module,exports){
"use strict";

module.exports = [/[Ff]\. ?(?:[123]d\.?)?/, /[Ff]\. ?[Ss]upp\. ?(?:[123]d\.?)?/, /[Ss]\. ?[Cc]t\.?/];
...
, { name: "Lexis" //{{{
  ...
  _typeSpecificUrls: { //{{{
    ...
    , docket_number: function docket_number(cite) {
      //{{{
      return this.baseUrl + "\"" + urlEncode(cite.mainCite) + "\"";
    } //}}}
    , default: function _default(cite) {
      //{{{
      ...
      var cleanedCitation = cite.fullCite.replace("\xB6 ", "").replace("\xB6", "");
...
, { name: "Casetext" //{{{
  ...
  _deepLinkableTypes: [],
  _cannot: allBut("scotus_us_reports", "federal_case", "docket_number", "default"),
  _typeSpecificUrls: { //{{{
    docket_number: function docket_number(cite) {
...
, { name: "CourtListener" //{{{
  ...
  _deepLinkableTypes: [],
  _cannot: allBut("us_constitution", "scotus_us_reports", "federal_case", "docket_number", "default"),
  _url: function _url(cite) {
    return this.baseUrl + "?citation=" + urlEncode(cite.mainCite);
  },
  _typeSpecificUrls: { //{{{
    docket_number: function docket_number(cite) {
      return this.baseUrl + "?docket_number=" + urlEncode(cite.rawNumber);
    }
  } //}}}
} //}}}
, { name: "Ravel" //{{{
  ...
  _deepLinkableTypes: ["usc", "frap", "frcp", "frcrmp", "frbp", "fre"],
  _cannot: ["uniform_commercial_code", "wl_database", "cfr", "public_law", "statutes_at_large", "federal_register", "scotus_us_reports", "law_journal"],
  _typeSpecificUrls: {
    usc: function usc(cite) {
      //{{{
...
, { name: "LII" //{{{
  ...
  $anchor: $("#link--lii__a"),
  _deepLinkableTypes: ["*"],
  _cannot: allBut("us_constitution", "cfr", "usc", "uniform_commercial_code", "frap", "frcrmp", "frcp", "fre", "frbp", "scotus_us_reports")
  ...
  , _typeSpecificUrls: { //{{{
    _federalRule: function _federalRule(typeName, cite) {
      //{{{
      var text = cite.fullCite;
      var jumpCiteMatch = void 0;
      var jumpCite = void 0;
    ...
    , us_constitution: function us_constitution(cite) {
      //{{{
      var article = "";
      var section = "";
    ...
    , uniform_commercial_code: function uniform_commercial_code(cite) {
      //{{{
    ...
    , scotus_us_reports: function scotus_us_reports(cite) {
      //{{{
...
, { name: "Google Scholar" //{{{
  ...
  _deepLinkableTypes: ["cfr", "usc", "frap", "frcp", "frcrmp", "frbp", "fre"],
  _cannot: ["uniform_commercial_code", "public_law", "statutes_at_large", "federal_register", "law_journal", "wl_database"],
  _url: function _url(cite) {
...
, { name: "Justia" //{{{
  ...
  _deepLinkableTypes: [],
  _cannot: ["federal_register", "public_law", "statutes_at_large", "usc", "law_journal", "wl_database"],
  _typeSpecificUrls: { //{{{
    cfr: function cfr(cite) {
      //{{{
...
, { name: "Fastcase" //{{{
  ...
  _cannot: allBut(),
  _typeSpecificUrls: { //{{{
    federal_case: function federal_case(cite) {
      //{{{
...
, { name: "Federal Digital System" //{{{
  ...
  _deepLinkableTypes: [],
  _cannot: allBut("federal_register", "public_law", "statutes_at_large"),
  _typeSpecificUrls: { //{{{
    federal_register: function federal_register(cite) {
      //{{{
      return this.baseUrl + ("?collection=fr&volume=" + cite.volume + "&page=" + cite.page);
    } //}}}
    , public_law: function public_law(cite) {
      //{{{
      return this.baseUrl + "?collection=plaw&lawtype=public&congress=" + cite.congress + "&lawnum=" + cite.law;
    } //}}}
    , statutes_at_large: function statutes_at_large(cite) {
      //{{{
...
function allBut() {
  //{{{
  var allCitationTypes = ["us_constitution", "cfr", "usc", "uniform_commercial_code", "wl_database", "public_law", "statutes_at_large", "federal_register", "frap", "frcrmp", "frcp", "fre", "frbp", "scotus_us_reports", "federal_case", "state_constitution", "law_journal", "law_statute_code_rule", "docket_number", "default"];

  for (var _len = arguments.length, exceptions = Array(_len), _key = 0; _key < _len; _key++) {
...
},{"../utils/escapeRegExp":15,"lodash/difference":145,"lodash/head":151}],5:[function(require,module,exports){
"use strict";

module.exports = ["Ala.", "Alaska", "Ariz.", "Ark.", "Cal.", "Colo.", "Conn.", "Del.", "Fla.", "Ga.", "Haw.", "Idaho", "Ill.", "Ind.", "Iowa", "Kan.", "Ky.", "La.", "Me.", "Md.", "Mass.", "Mich.", "Minn.", "Miss.", "Mo.", "Mont.", "Neb.", "Nev.", "N.H.", "N.J.", "N.M.", "N.Y.", "N.C.", "N.D.", "Ohio", "Okla.", "Or.", "Pa.", "R.I.", "S.C.", "S.D.", "Tenn.", "Tex.", "Utah", "Vt.", "Va.", "Wash.", "W. Va.", "Wis.", "Wyo."];

},{}],6:[function(require,module,exports){
"use strict";

var head = require("lodash/head");
var captureGroup = require("../utils/captureGroup");
var curry = require("../utils/curry");
var matchAnyOf = require("../utils/matchAnyOf");
var matchAllOf = require("../utils/matchAllOf");
var anyStateAbbreviation = matchAnyOf.apply(null, require("./state_abbreviations"));
var anyFederalCaseReporter = matchAnyOf.apply(null, require("./federal_case_reporters"));
var fedRuleNumberWithJump = curry(federalRuleNumber)(true);
var fedRuleNumber = curry(federalRuleNumber)(false);

module.exports = [{ typeId: "us_constitution" //{{{
  , idPattern: /U\.?S\.? Const/i,
  mainCitePattern: /(.+), cl\./,
  _subparts: { article: function article(c) {
      return captureGroup(/art(?:\.?|icle) ?([0-9ivxlc]+)/i, c);
    },
    section: function section(c) {
      return captureGroup(/(?:sect(?:\.|ion)?|\u00a7) ?([0-9ivxlc]+)/i, c);
    }
  }
} //}}}
, { typeId: "cfr" //{{{
  ...
  _subparts: { title: function title(c) {
      return head(c.match(/\d+/));
    },
    section: function section(c) {
      return captureGroup(/\d+\D+(?:sect(?:\.|ion)?|\u00a7)? ?([0-9\.]+)/i, c);
    },
    part: function part(c) {
      return captureGroup(/(\d+)\.\d+/, c);
    }
  }
} //}}}
, { typeId: "usc" //{{{
  ...
  _subparts: { title: function title(c) {
    ...
    section: function section(c) {
      return captureGroup(/\d+\D+(?:sect(?:\.|ion)?|\u00a7)? ?([\w\-\.]+)/i, c);
    }
  }
} //}}}
...
, { typeId: "public_law" //{{{
  ...
  mainCitePattern: /(.*)/,
  _subparts: { congress: function congress(c) {
      return captureGroup(/(\d*)-\d*/, c);
    },
    law: function law(c) {
      return captureGroup(/\d*-(\d*)/, c);
...
, { typeId: "statutes_at_large" //{{{
  ...
  mainCitePattern: /(.*)/,
  _subparts: { volume: function volume(c) {
      return head(c.match(/^\d+/));
    },
    page: function page(c) {
      return captureGroup(/stat\.? (\d+)/i, c);
    }
  }
} //}}}
...
, { typeId: "scotus_us_reports" //{{{
  ...
  mainCitePattern: /(.+\d{1,5})(?:, [\d,]{1,6})/,
  _subparts: { volume: function volume(c) {
      return captureGroup(/(\d+)/, c);
    },
    page: function page(c) {
      return captureGroup(/\d+\s+(?:U\.? ?S\.?)\s+([0-9]+)/i, c);
    }
  }
} //}}}
, { typeId: "federal_case" //{{{
  ...
  _subparts: { volume: function volume(c) {
    ...
    reporter: function reporter(c) {
      return head(c.match(anyFederalCaseReporter));
    },
    page: function page(c) {
      return captureGroup(matchAllOf(anyFederalCaseReporter, / (\d{1,5})/), c);
    }
  }
} //}}}
...
, { typeId: "law_journal" //{{{
  , idPattern: matchAnyOf(/L\. ?J\./, /L\. ?Rev\./, /J\.[\w&'.\s]+L\./, "J.L. & Econ.", "J. Emp. Legal Stud.", "J. Legal Stud.", "L. & Contemp. Probs.", "Sup. Ct. Rev.")
...
, { typeId: "docket_number" //{{{
  , idPattern: /^No\. \d+/i,
  mainCitePattern: /(.+)/,
  _subparts: { rawNumber: function rawNumber(c) {
      return c.slice(4);
    } }
} //}}}
, { typeId: "default" //{{{
...
function federalRuleNumber(withJumpCite, citeText) {
  var matcher = withJumpCite ? /\d+\.?\d* ?(?:\([^)]{1,4}\) ?)*/ : /\d+(?:\.\d+)?/;
  var ruleNumberMatch = void 0;
...
},{"../utils/captureGroup":13,"../utils/curry":14,"../utils/matchAllOf":17,"../utils/matchAnyOf":18,"./federal_case_reporters":3,"./state_abbreviations":5,"lodash/head":151}],7:[function(require,module,exports){
"use strict";
...
},{"../utils/curry":14}],8:[function(require,module,exports){
"use strict";
...
module.exports = function genericUrl(cite) {
  var properCitation = urlEncode(this.canDeepLink(cite.type) ? cite.fullCite : cite.mainCite);

  return this.baseUrl + properCitation;
};

},{"lodash/includes":153}],9:[function(require,module,exports){
"use strict";
...
},{"../utils/after":12}],10:[function(require,module,exports){
"use strict";

var extend = $.extend;
var trim = $.trim;
var compact = require("lodash/compact");
var requireFields = require("../utils/requireFields");
var citationTypes = require("../data/type_list");
var detectType = require("../functions/detectType");
...
function buildMainCite(citationText, mainCitePattern) {
  ...
  return !!matchData ? compact(matchData)[1] : citationText;
}

function buildJumpCite(citationText, mainCiteText) {
  return citationText === mainCiteText ? "" : citationText.slice(mainCiteText.length);
}
...
},{"../data/type_list":6,"../functions/detectType":7,"../utils/requireFields":19,"lodash/compact":143}],11:[function(require,module,exports){
"use strict";
...
var includes = require("lodash/includes");
var genericUrl = require("../functions/genericUrl");
...
extend(Source.prototype, {
  ...
  canHandle: function canHandle(type) {
    return includes(this._cannot, type) ? false : true;
  },
...
},{"../functions/genericUrl":8,"../utils/after":12,"../utils/extend":16,"../utils/requireFields":19,"lodash/includes":153}],12:[function(require,module,exports){
"use strict";
...
module.exports = function captureGroup(pattern, string) {
...
module.exports = function extend(consumer) {
  var key = void 0;
  var i = void 0;
  var provider = void 0;

  for (var _len = arguments.length, providers = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
    providers[_key - 1] = arguments[_key];
  }
...
// or worse,
//    /[Hh][Tt][Mm][Ll]/
module.exports = function matchAllOf() {
...
},{"./escapeRegExp":15,"lodash/reduce":169}],18:[function(require,module,exports){
"use strict";
...
// or worse,
//    /[Hh][Tt][Mm][Ll]/
module.exports = function matchAnyOf() {
  for (var _len = arguments.length, list = Array(_len), _key = 0; _key < _len; _key++) {
    list[_key] = arguments[_key];
  }
...
},{"./escapeRegExp":15,"lodash/reduce":169}],19:[function(require,module,exports){
"use strict";
...
module.exports = function requiredFields(obj) {
  ...
  each(fields, function (_idx, f) {
    if (!(f in obj)) {
      throw "Required field " + f + " not in " + Object.keys(obj);
    }
  });
  return true;
};
...
},{"select":176}],21:[function(require,module,exports){
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
...
},{"./clipboard-action":20,"good-listener":25,"tiny-emitter":177}],22:[function(require,module,exports){
/**
...
},{"./closest":22}],24:[function(require,module,exports){
/**
...
},{"./_getNative":92,"./_root":128}],28:[function(require,module,exports){
...
},{"./_getNative":92,"./_root":128}],31:[function(require,module,exports){
...
},{"./_getNative":92,"./_root":128}],33:[function(require,module,exports){
var getNative = require('./_getNative'),
    root = require('./_root');
...
},{"./_getNative":92,"./_root":128}],34:[function(require,module,exports){
...
},{"./_getNative":92,"./_root":128}],39:[function(require,module,exports){
/**
...
},{"./_baseIndexOf":58}],42:[function(require,module,exports){
/**
...
},{"./_baseTimes":75,"./_isIndex":103,"./isArguments":154,"./isArray":155,"./isBuffer":158,"./isTypedArray":165}],44:[function(require,module,exports){
/**
...
},{"./eq":147}],49:[function(require,module,exports){
...
},{"./_SetCache":34,"./_arrayIncludes":41,"./_arrayIncludesWith":42,"./_arrayMap":44,"./_baseUnary":77,"./_cacheHas":79}],50:[function(require,module,exports){
...
},{"./_baseForOwn":54,"./_createBaseEach":83}],51:[function(require,module,exports){
/**
...
},{"./_arrayPush":45,"./_isFlattenable":102}],53:[function(require,module,exports){
...
},{"./_createBaseFor":84}],54:[function(require,module,exports){
...
},{"./_baseFor":53,"./keys":166}],55:[function(require,module,exports){
...
},{"./_castPath":81,"./_toKey":141}],56:[function(require,module,exports){
...
},{"./_Symbol":36,"./_getRawTag":93,"./_objectToString":125}],57:[function(require,module,exports){
/**
...
},{"./_baseFindIndex":51,"./_baseIsNaN":63,"./_strictIndexOf":139}],59:[function(require,module,exports){
...
},{"./_baseGetTag":56,"./isObjectLike":162}],60:[function(require,module,exports){
...
},{"./_baseIsEqualDeep":61,"./isObject":161,"./isObjectLike":162}],61:[function(require,module,exports){
...
},{"./_Stack":35,"./_equalArrays":86,"./_equalByTag":87,"./_equalObjects":88,"./_getTag":94,"./isArray":155,"./isBuffer":158,"./isTypedArray":165}],62:[function(require,module,exports){
var Stack = require('./_Stack'),
...
},{"./_isMasked":106,"./_toSource":142,"./isFunction":159,"./isObject":161}],65:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
...
},{"./_baseGetTag":56,"./isLength":160,"./isObjectLike":162}],66:[function(require,module,exports){
...
},{"./_baseMatches":68,"./_baseMatchesProperty":69,"./identity":152,"./isArray":155,"./property":168}],67:[function(require,module,exports){
...
},{"./_isPrototype":107,"./_nativeKeys":123}],68:[function(require,module,exports){
...
},{"./_baseIsMatch":62,"./_getMatchData":91,"./_matchesStrictComparable":120}],69:[function(require,module,exports){
...
},{"./_baseIsEqual":60,"./_isKey":104,"./_isStrictComparable":108,"./_matchesStrictComparable":120,"./_toKey":141,"./get":149,"./hasIn":150}],70:[function(require,module,exports){
/**
...
},{"./_overRest":127,"./_setToString":132,"./identity":152}],74:[function(require,module,exports){
...
},{"./_defineProperty":85,"./constant":144,"./identity":152}],75:[function(require,module,exports){
/**
...
},{"./_Symbol":36,"./_arrayMap":44,"./isArray":155,"./isSymbol":164}],77:[function(require,module,exports){
/**
...
},{"./_arrayMap":44}],79:[function(require,module,exports){
/**
...
},{"./identity":152}],81:[function(require,module,exports){
...
},{"./_isKey":104,"./_stringToPath":140,"./isArray":155,"./toString":174}],82:[function(require,module,exports){
var root = require('./_root');
...
},{"./_root":128}],83:[function(require,module,exports){
...
},{"./isArrayLike":156}],84:[function(require,module,exports){
/**
...
},{"./_getNative":92}],86:[function(require,module,exports){
var SetCache = require('./_SetCache'),
...
},{"./_SetCache":34,"./_arraySome":47,"./_cacheHas":79}],87:[function(require,module,exports){
var Symbol = require('./_Symbol'),
...
},{"./_Symbol":36,"./_Uint8Array":37,"./_equalArrays":86,"./_mapToArray":119,"./_setToArray":131,"./eq":147}],88:[function(require,module,exports){
...
},{"./keys":166}],89:[function(require,module,exports){
(function (global){
...
},{"./_isStrictComparable":108,"./keys":166}],92:[function(require,module,exports){
...
},{"./_baseIsNative":64,"./_getValue":95}],93:[function(require,module,exports){
var Symbol = require('./_Symbol');
...
},{"./_Symbol":36}],94:[function(require,module,exports){
...
},{"./_DataView":27,"./_Map":30,"./_Promise":32,"./_Set":33,"./_WeakMap":38,"./_baseGetTag":56,"./_toSource":142}],95:[function(require,module,exports){
/**
...
},{"./_castPath":81,"./_isIndex":103,"./_toKey":141,"./isArguments":154,"./isArray":155,"./isLength":160}],97:[function(require,module,exports){
...
},{"./_Symbol":36,"./isArguments":154,"./isArray":155}],103:[function(require,module,exports){
/** Used as references for various `Number` constants. */
...
},{"./isArray":155,"./isSymbol":164}],105:[function(require,module,exports){
/**
...
},{"./isObject":161}],109:[function(require,module,exports){
/**
...
},{"./_assocIndexOf":48}],111:[function(require,module,exports){
var assocIndexOf = require('./_assocIndexOf');
...
},{"./memoize":167}],122:[function(require,module,exports){
var getNative = require('./_getNative');
...
},{"./_getNative":92}],123:[function(require,module,exports){
...
},{"./_freeGlobal":89}],125:[function(require,module,exports){
/** Used for built-in method references. */
var objectProto = Object.prototype;
...
},{"./_freeGlobal":89}],129:[function(require,module,exports){
/** Used to stand-in for `undefined` hash values. */
var HASH_UNDEFINED = '__lodash_hash_undefined__';
...
},{"./_baseSetToString":74,"./_shortOut":133}],133:[function(require,module,exports){
...
},{"./_memoizeCapped":121}],141:[function(require,module,exports){
...
},{"./isSymbol":164}],142:[function(require,module,exports){
/** Used for built-in method references. */
var funcProto = Function.prototype;
...
},{"./_baseDifference":49,"./_baseFlatten":52,"./_baseRest":73,"./isArrayLikeObject":157}],146:[function(require,module,exports){
module.exports = require('./forEach');

},{"./forEach":148}],147:[function(require,module,exports){
/**
 * Performs a
...
},{"./_arrayEach":40,"./_baseEach":50,"./_castFunction":80,"./isArray":155}],149:[function(require,module,exports){
var baseGet = require('./_baseGet');
...
},{"./_baseGet":55}],150:[function(require,module,exports){
...
},{"./_baseHasIn":57,"./_hasPath":96}],151:[function(require,module,exports){
/**
...
},{"./_baseIndexOf":58,"./isArrayLike":156,"./isString":163,"./toInteger":172,"./values":175}],154:[function(require,module,exports){
...
},{"./_baseIsArguments":59,"./isObjectLike":162}],155:[function(require,module,exports){
/**
...
},{"./_root":128,"./stubFalse":170}],159:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isObject = require('./isObject');
...
},{"./_baseGetTag":56,"./isObject":161}],160:[function(require,module,exports){
/** Used as references for various `Number` constants. */
var MAX_SAFE_INTEGER = 9007199254740991;
...
},{"./_baseGetTag":56,"./isArray":155,"./isObjectLike":162}],164:[function(require,module,exports){
var baseGetTag = require('./_baseGetTag'),
    isObjectLike = require('./isObjectLike');
...
},{"./_baseGetTag":56,"./isObjectLike":162}],165:[function(require,module,exports){
...
},{"./_baseIsTypedArray":65,"./_baseUnary":77,"./_nodeUtil":124}],166:[function(require,module,exports){
...
},{"./_arrayLikeKeys":43,"./_baseKeys":67,"./isArrayLike":156}],167:[function(require,module,exports){
var MapCache = require('./_MapCache');
...
},{"./_MapCache":31}],168:[function(require,module,exports){
...
},{"./_baseProperty":70,"./_basePropertyDeep":71,"./_isKey":104,"./_toKey":141}],169:[function(require,module,exports){
...
},{"./_arrayReduce":46,"./_baseEach":50,"./_baseIteratee":66,"./_baseReduce":72,"./isArray":155}],170:[function(require,module,exports){
/**
...
},{"./toFinite":171}],173:[function(require,module,exports){
var isObject = require('./isObject'),
    isSymbol = require('./isSymbol');
...
},{"./isObject":161,"./isSymbol":164}],174:[function(require,module,exports){
...
},{"./_baseToString":76}],175:[function(require,module,exports){
...
},{"./_baseValues":78,"./keys":166}],176:[function(require,module,exports){
